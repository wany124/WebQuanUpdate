...
import EditorPastTalkPage from "@/pages/editor-past-talk-page";
import PastTalksPage from "@/pages/past-talk-page";
...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/talks" component={PastTalksPage} />
      {/* Auth */}
      ...
      <ProtectedRoute path="/editor/talks" component={EditorPastTalkPage} />
